...
### Step 25: 脳活動とWAIS-IV下位検査・プロセス分析の相関解析

全検査IQをさらに分解し、具体的な認知機能（下位検査）と脳活動の相関を解析した。

| 項目 | 内容 |
|:---|:---|
| **脳指標** | HbT_DT (拡散的思考), HbT_CT (収束적思考) |
| **心理指標** | WAIS-IV 下位検査 (10項目) および プロセス分析指標 |
| **可視化** | R (ggplot2) による相関ヒートマップ出力 |

#### 1. 下位検査・プロセス分析ヒートマップ
![Subtest Heatmap]<img width="1800" height="3000" alt="heatmap_subtests" src="https://github.com/user-attachments/assets/87a4c7d7-9992-4db3-8052-1aec7785f33b" />


#### 2. 主要な統計的知見 (Significant Findings)

| 下位検査 / プロセス | 脳指標 | 相関係数 $r$ | $p$ 値 | 判定 |
|:---|:---|:---:|:---:|:---|
| **類似 (Similarities)** | **HbT_CT** | **-0.551** | **0.005** | **有意 (p < 0.01)** |
| **数唱：逆唱 (Backward)** | **HbT_CT** | **-0.501** | **0.013** | **有意 (p < 0.05)** |
| **数唱 (Digit Span Total)**| **HbT_CT** | **-0.444** | **0.030** | **有意 (p < 0.05)** |
| 符号探し (Symbol Search) | HbT_CT | -0.398 | 0.054 | † 有意傾向 |

#### 3. 結論：収束的思考を支える「概念化」と「脳内操作」
収束的思考（CT）において、言語的な共通性を抽出する「類似」と、情報を保持しつつ加工する「数唱：逆唱」が強い神経効率性を示した。これは、論理的な思考の「整理（抽象化）」と「操作（WM）」の能力が高い個人ほど、前頭前野の神経資源を節約できていることを示唆している。
